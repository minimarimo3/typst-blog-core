...
#import "../../components/font-config.typ": google-font-families, font-css-lines
...
#let common-head(
  ...
  html.link(rel: "stylesheet", href: base-path + "/_core/styles/components.css")
  html.link(rel: "stylesheet", href: base-path + "/_core/styles/pages.css")
  // Font defaults precede theme overrides (--font-{key}).
  ...
  html.link(rel: "stylesheet", href: base-path + "/styles/theme.css")
  ...
  html.elem("script", attrs: (type: "module", src: base-path + "/_core/scripts/main.js"))
